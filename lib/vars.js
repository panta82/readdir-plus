...
exports.DEFAULT_OPTIONS = {
	...
	/*
		Options for content loading. Set false/true to disable/enable with default options. TODO
	 */
	content: {
		...
		// Functions called with fn(fullPath, stat). Regexes applied to full path.
		asText: [/(\.txt|\.json|\.xml|\.htaccess|\.config|\.cfg|\.html|\.htm|\.xhtml|.md)$/],
	...
	/*
		Synchronous call. Returns results instead of callback. //TODO
	 */
	sync: false,
